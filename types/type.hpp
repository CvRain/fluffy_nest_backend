...
namespace exception {
    ...
    public:
        explicit                                   BaseException(const type::BasicResponse& error);
        [[nodiscard]] const char*                  what() const noexcept override;
        [[nodiscard]] type::BasicResponse response() const;
    ...
    private:
        type::BasicResponse base_error;
    };

    inline BaseException::BaseException(const type::BasicResponse& error) :
        base_error(type::BasicResponse{
    ...
    inline type::BasicResponse BaseException::response() const{
        return base_error;
    }
