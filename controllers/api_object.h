...
namespace api {
    ...
    public:
        ...
        METHOD_ADD(Object::exist_object, "/exist", Get, filter::keywords::enable_cores_v2, filter::keywords::user_auth);

        METHOD_ADD(
                Object::append_object, "/append", Post, filter::keywords::enable_cores_v2, filter::keywords::user_auth);

        METHOD_ADD(
                Object::remove_object, "/remove", Post, filter::keywords::enable_cores_v2, filter::keywords::user_auth);

        METHOD_ADD(Object::object_url, "/url", Get, filter::keywords::enable_cores_v2, filter::keywords::user_auth);
